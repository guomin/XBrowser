...
namespace AxeFrog.Net
{
	...
	public abstract class HttpBrowser : IDisposable
	{
		...
		public event Action<HttpBrowser, string> MessageLogged;
		public event Action<HttpBrowser, HttpRequestLog> RequestLogged;
		public event Action<HttpBrowser, Image> ScreenshotLogged;
