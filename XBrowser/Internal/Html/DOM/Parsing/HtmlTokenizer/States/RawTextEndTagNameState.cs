...
{
    internal class RawTextEndTagNameState : TokenizerState
    {
        private TagToken stateToken;

        public RawTextEndTagNameState(TagToken token)
        {
            stateToken = token;
        }
        ...
        public override bool ParseTokenFromDataStream(Tokenizer tokenizer)
        {
            ...
            else
            {
                ...
                else if (HtmlCharacterUtilities.IsUpperCaseLetter(currentChar))
                {
                    ...
                    tokenizer.AdvanceState(new RawTextEndTagNameState(stateToken));
                }
