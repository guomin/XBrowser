...
namespace XBrowserProject.Internal
{
	internal class Window : IHTMLWindow
	{
		...
		public Window(Uri url)
		{
			htmlParser = new Parser(this, url);
		...
		public void LoadString(string htmlSource)
		{
			LoadDocument(new StringReader(htmlSource));
		}
